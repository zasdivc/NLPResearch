...
#
random_sample = df.sample(n=5000, random_state=10)

random_sample.to_csv('ChnSentiCorp_htl_first_5000_new_v1.csv', index=False)

rest = df.drop(random_sample.index)

rest.to_csv('ChnSentiCorp_htl_rest_new_v1.csv', index=False)